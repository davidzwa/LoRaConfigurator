...
public class RlncFlashBlobService
{
    ...
    public async Task GenerateFlashBlob()
    {
        ...
        var pRngSeedState = config.PRngSeedState;
        var templateFileName = $"rlnc_{fragCount}f_{fragSize}b_fake_{genCount}g_{redCount}r_{pRngSeedState}rng";
        ...
        Log.Information("Cleanup blob generator with PRNG seed {Seed}", pRngSeedState);
